...
# BIT Full stack developer course – Part 7. Practice No.3: React Bitflix
...
This project is a part of my workbook from Full stack developers course at BIT This is the 7th part of the course. Pratcice No.3 React Bitflix

This project is for educational porpuses only. Pull request are welcome, but priority for project authors! Thank you for your cooperation!

Design inspired by [Netflix](https://netflix.com) 

View deployed result on [my github](https://madrakas.github.io/bit_07_03_homework_bitflix)
...
7. [React intro. Initialisation](https://github.com/madrakas/bit_07_react_intro)
    ...
    3. Practice No.3 React Bitflix (current repository)
...
1. Clone the repo
    ```sh
    git clone https://github.com/madrakas/bit_07_02_homework_calculator
    ```
